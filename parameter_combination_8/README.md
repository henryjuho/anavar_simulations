...
$ ~/anavar_simulations/scripts/extract_best_result_3class.py -r_dir full/ -r_dir no_pol_gmax5000/ -t 0.002,0.006,0.002 -g 0,-5,-30 -e 0.05,0.02,0.01 > comb_8_full_no_pol_gmax5000.bestlnL.txt
...
$ ~/anavar_simulations/scripts/process_anavar1.2_reps_snp_3class.py -lnL comb_8_full_no_pol_gmax5000.bestlnL.txt -df 3 > comb_8_full_no_pol_gmax5000.csv
...
$ grep -v ^e comb_8_full_no_pol_gmax5000.csv | while read i; do echo $i,no_pol_gmax_5000; done >> rtest_snp_3class_5e6.csv
```