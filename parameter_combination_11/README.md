...
$ ~/anavar_simulations/scripts/extract_best_result_1.2_indel_disc.py -ti 0.0005 -td 0.001 -gi " -5" -gd " -15" -ei 0.02 -ed 0.02 -r_dir full/ > comb_11_full.bestlnL.txt

$ ~/anavar_simulations/scripts/process_anavar1.2_reps_indel_disc.py -lnL comb_11_full.bestlnL.txt > comb_11_full.csv 
```