...
$ cat 100_sfs_indels_1class_2e6.txt | ~/anavar_simulations/scripts/sim_sfs2control_file.py -control_file indel_param11.neutral.control.txt -mode INDEL -out_dir neutral/ -model reduced
