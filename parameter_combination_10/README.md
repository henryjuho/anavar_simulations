...
$ ~/anavar_simulations/snp_3class_rtests/extract_best_result_3class.py -t 0.002,0.006,0.002 -g 0,-5,-30 -e 0.05,0.02,0.01 -r_dir full/ -r_dir equal_pol/ > comb_10_full_equal_pol.bestlnL.txt
$ ~/anavar_simulations/snp_3class_rtests/extract_best_result_3class.py -t 0.002,0.006,0.002 -g 0,-5,-30 -e 0.05,0.02,0.01 -r_dir full/ -r_dir 2class/ > comb_10_full_2class.bestlnL.txt
$ ~/anavar_simulations/snp_3class_rtests/process_anavar1.2_reps_snp_3class.py -lnL comb_10_full_equal_pol.bestlnL.txt -df 2 > comb_10_full_equal_pol.csv
$ ~/anavar_simulations/snp_3class_rtests/process_anavar1.2_reps_snp_3class.py -lnL comb_10_full_2class.bestlnL.txt -df 3 > comb_10_full_2class.csv
